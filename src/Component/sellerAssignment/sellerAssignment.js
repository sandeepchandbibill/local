...
import InventoryTaskMangement from '../InventoryMangement/invetoryTaskManagement';
class Task extends Component {
  ...
  getSearchData = () =>{
    ...
    render() {
     ...
     if(this.state.management === 'Inventory_Management')
     {
       return(
        <InventoryTaskMangement></InventoryTaskMangement>
      ...
      return (
        ...
        <Row>
          <Col>
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i> Seller Task Assign
